...
SECRET_KEY = 'django-insecure-t=5^ra+m23d(-h2##jfv4$44g$&8d8aa30)-5#9gz6ttin@(n5'
...
# Use the shared SQLite DB
# auth-service/settings.py

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': '/db_sharing/db.sqlite3',  # DO NOT use BASE_DIR here
    }
}

# 3. Allow your frontend port
